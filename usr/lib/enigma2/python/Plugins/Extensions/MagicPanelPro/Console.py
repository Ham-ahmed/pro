...
plugin_path = resolveFilename(SCOPE_PLUGINS, "Extensions/{}".format('MagicapanelPro'))
...
class Console(Screen):
	...
	def __init__(self, session, title='MagicapanelPro Console', cmdlist=None, finishedCallback=None, closeOnSuccess=False, showStartStopText=True, skin=None):
		Screen.__init__(self, session)
		self.finishedCallback = finishedCallback
		self.closeOnSuccess = closeOnSuccess
		self.showStartStopText = showStartStopText

		skin = os.path.join(skin_path, 'Console.xml')
		...
		self.newtitle = title == 'MagicapanelPro Console' and ('Console') or title
